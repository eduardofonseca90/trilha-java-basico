...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if (atendeu) {
            ...
            System.err.println("NÃO CONSEGUIMOS CONTATO COM " + candidato + ", NÚMERO MÁXIMO DE TENTATIVAS " + tentativasRealizadas + " REALIZADA ");
    }
    ...
    static void selecaoCandidatos () {
        String [] candidatos = {"FELIPE", "MARCIA", "JULIA", "AUGUSTO", "MONICA", "FABRICIO", "MIRELA", "DANIELA", "RODRIGO", "JOÃO"};
